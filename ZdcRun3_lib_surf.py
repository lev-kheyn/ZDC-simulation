...
outFile = "zdc" + options.type + "_lib_surface_x25_y25_n2000gev_1000.root"
globalTag = "auto:phase1_2022_realistic"

process.load("IOMC.EventVertexGenerators.VtxSmearedGauss_cfi")

process.VtxSmeared.MeanX = 2.5     
process.VtxSmeared.MeanY = 2.5
...
process.RandomNumberGeneratorService.generator.initialSeed = 45678410
process.RandomNumberGeneratorService.g4SimHits.initialSeed = 987410
process.RandomNumberGeneratorService.VtxSmeared.initialSeed = 123456410
process.rndmStore = cms.EDProducer("RandomZdcRun3_lib_surf_nwatch_neut.pyEngineStateProducer")
...
process.g4SimHits.ZdcSD.UseShowerHits = cms.bool(False)
